...
<section class="page-section color">
    <div class="container">
        <div class="row">
                    ...
                    <div class="row">
                        ...
                        {{-- <div class="col-md-12">
                                <div class="form-group">
                                    <input class="form-control" name="email" type="text" placeholder="{{ trans('general.email') }}">
                    </div>
                    @if ($errors->has('email'))
            ...
            <div class="col-md-12">
                <div class="form-group">
                    <input class="form-control" name="mobile" type="text" placeholder="{{ trans('general.mobile') }}"></div>
