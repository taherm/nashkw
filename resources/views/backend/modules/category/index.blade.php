                                        ...
                                        <div class="btn-group">
                                            ...
                                            <ul class="dropdown-menu pull-right" role="menu">
                                                ...
                                                <li>
                                                    ...
                                                    <form method="post" id="delete-{{ $child->id }}" action="{{ route('backend.category.destroy',$child->id) }}">
                                                        @csrf
                                                    ...
                                                    <ul class="dropdown-menu pull-right" role="menu">
                                                        ...
                                                        <li>
                                                            <a data-toggle="modal" href="#" data-target="#basic" data-title="Delete" data-content="Are you sure you want to delete {{ $sub->name  }}? " data-form_id="delete-{{ $sub->id }}">
                                                                ...
                                                                delete</a>
                                                            <form method="post" id="delete-{{ $sub->id }}" action="{{ route('backend.category.destroy',$sub->id) }}">
                                                                @csrf
                                                                <input type="hidden" name="_method" value="delete" />
                                                                <button type="submit" class="btn btn-del hidden">
                                    ...
                                    <ul class="dropdown-menu pull-right" role="menu">
                                        ...
                                        <li>
                                            <a data-toggle="modal" href="#" data-target="#basic" data-title="Delete" data-content="Are you sure you want to delete {{ $element->name  }}? " data-form_id="delete-{{ $element->id }}">
                                                <i class="fa fa-fw fa-recycle"></i> delete</a>
                                            <form method="post" id="delete-{{ $element->id }}" action="{{ route('backend.category.destroy',$element->id) }}">
                                                @csrf
                                                <input type="hidden" name="_method" value="delete" />
                                                <button type="submit" class="btn btn-del hidden">
                                                    <i class="fa fa-fw fa-times-circle"></i> delete
