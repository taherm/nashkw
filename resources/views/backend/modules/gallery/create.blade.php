...
<div class="portlet box blue">
    ...
    <div class="portlet-body form">
        <form class="horizontal-form" role="form" method="POST" action="{{ route('backend.gallery.store') }}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-body">
                <div class="row">
                    <div class="col-lg-6">
                        <div class="form-group">
                            ...
                            <div class="col-md-10">
                                <input type="text" name="name_ar" value="{{ old('name_ar')}}" class="form-control" placeholder="Enter text">
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-6">
                        <div class="form-group">
                            ...
                            <div class="col-md-10">
                                <input type="text" name="name_en" value="{{ old('name_en') }}" class="form-control" placeholder="Enter text">
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-6">
                        <div class="form-group">
                            <label for="file" class="control-label col-sm-2">cover image*</label>
                            <div class="col-sm-10">
                                <input class="form-control tooltip-message" name="cover" placeholder="main image" type="file" required />
                    ...
                    <div class="col-lg-6">
                        <div class="form-group">
                            <label for="file" class="control-label col-sm-2">more images</label>
                            <div class="col-sm-10">
                ...
                <div class="row">
                    <div class="col-lg-5 col-lg-offset-1">
                        <div class="form-group">
                            <label for="description_ar" class="control-label">description_ar</label>
