                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="form-group {{ $errors->has('sku') ? ' has-error' : '' }}">
                            ...
                            <input id="sku" type="text" class="form-control" name="sku" value="{{ old('sku') }}" placeholder="Product Code" required autofocus>
                            @if ($errors->has('sku'))
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="form-group{{ $errors->has('video_url') ? ' has-error' : '' }}">
                            ...
                            <input id="video_url" type="text" class="form-control" name="video_url" value="{{ old('video_url') }}" placeholder="video_url arabic" autofocus>
