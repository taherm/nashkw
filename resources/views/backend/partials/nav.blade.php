    ...
    <div class="page-header-inner ">
        ...
        <div class="page-logo">
            <a href="{{ route('backend.index') }}">
                <img src="{{ asset('storage/uploads/images/medium/'.$settings->logo) }}" alt="logo" class="img-logo logo-default" /> </a>
                ...
                <ul class="dropdown-menu" role="menu">
                    ...
                    <li>
                        <a href="{{ route('backend.currency.create') }}">
                            <i class="icon-globe"></i> Create New Currency</a>
                    </li>
                    <li class="divider"></li>
                    <li>
                        <a href="{{ route('backend.slider.create') }}">
                            <i class="icon-paper-clip"></i> Create New Slider</a>
                    </li>
                    {{--<li>--}}
                ...
                <ul class="nav navbar-nav pull-right">
                    ...
                    <li class="dropdown dropdown-user">
                        <a href="javascript:;" class="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown" data-close-others="true">
                            <img alt="" class="img-circle img-xs" src="{{ asset('storage/uploads/images/thumbnail/'. auth()->user()->logo) }}" />
