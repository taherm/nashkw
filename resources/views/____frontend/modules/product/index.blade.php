            ...
            <div class="row">
                ...
                <!--breadcrumbs end-->
                    ...
                    <div class="shop-product-view">
                        <!-- Shop Product Tab Area -->{!! request()->fullUrlWithQuery(['brand_id' => $brand->id]) !!}
                        ...
                        <!-- Tab Content -->
                            ...
                            <div class="tab-content">
                                <div id="shop-grid" class="tab-pane active" role="tabpanel">
                                    <div class="row">
                                        @include('____frontend.modules.product.partials.product_category',['products' => $elements ,'cols' => 'col-lg-3 col-md-3 col-sm-3'])
                                    </div>
                                </div>
                            </div>
                            {{--@include('frontend.modules.category.partials._bottom_toolbar')--}}
                        </div>
                        @include('____frontend.modules.category.partials._tags')
                    </div>
                </div>
            </div>
        </div>
