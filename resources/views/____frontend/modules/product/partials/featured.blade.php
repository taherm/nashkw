        ...
        <div class="row">
            <div class="feature-product-4 product-carousel derection-key">
                ...
                @if(!is_null($newArivals))
                    @include('____frontend.modules.product._product',['products' => $newArivals])
                @endif
            </div>
            <!-- carousel-end -->
        </div>
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="feature-product-4 product-carousel derection-key">
                <!-- single-product start -->
                @if(!is_null($onSale))
                    @include('____frontend.modules.product._product',['products' => $onSale])
                @endif
            </div>
            <!-- carousel-end -->
        </div>
        ...
        <div class="row">
            <div class="feature-product-4 product-carousel derection-key">
                ...
                @if(!is_null($bestSales))
                    @include('____frontend.modules.product._product',['products' => $bestSales])
                @endif
            </div>
            <!-- carousel-end -->
        </div>
