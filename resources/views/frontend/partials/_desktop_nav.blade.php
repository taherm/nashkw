<div class="navigation-wrapper">
                ...
                <li class="megamenu">
                    ...
                    {{-- <ul>
                        <li class="row">
                            ...
                            <div class="col-md-2">
                                <h4 class="block-title"><span><a href="{{ route('frontend.product.search', ['category_id' => $child->id]) }}"><strong>{{ $child->name }}</strong></a></span>
                    </h4>
    ...
    @endif
    <li class="visible-sm">
        <a class="no-child" href="https://api.whatsapp.com/send?phone={{ $settings->whatsapp  }}">{{ trans('general.whatsapp') }}</a>
    </li>
    <li class="visible-sm">
        <a class="no-child" href="tel:{{ $settings->mobile }}">{{ trans('general.mobile') }}</a>
    </li>
    <li class="visible-sm">
