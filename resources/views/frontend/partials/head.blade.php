...
<meta itemprop="image" content="{{url('http://nashkw.com/images/logo.jpg')}}">
...
<meta property="og:image" content="{{url('http://nashkw.com/images/logo.jpg')}}">
...
<meta name="twitter:image" content="{{url('http://nashkw.com/images/logo.jpg')}}">