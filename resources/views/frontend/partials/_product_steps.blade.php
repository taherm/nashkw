<div class="mt-element-step">
    <div class="row step-default">
        ...
        <div class="col-md-4 bg-grey mt-step-col {{ Route::currentRouteName() === 'backend.product.index' ? 'active' : null  }}">
            <div class="mt-step-number bg-white font-grey">3</div>
            <div class="mt-step-title uppercase font-grey-cascade">View Products</div>
            <div class="mt-step-content font-grey-cascade">Check all of your products</div>
        </div>
    </div>
    <br/>
    <br/>
