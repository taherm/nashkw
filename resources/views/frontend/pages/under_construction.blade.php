...
@section('footer')
    <footer>
        ...
        <a href="https://www.instagram.com/nash/" class="social" style="color: #e4405f" target="_blank">
            <img src="{{ asset('images/instagram.png') }}" alt="" class="img-xs">
        </a>
        <a href="https://www.snapchat.com/add/nash" class="social" style="color: #FFFC00" target="_blank">
            <img src="{{ asset('images/snap.png') }}" alt="" class="img-xs">
        </a>
        <a href="https://www.twitter.com/nash/" class="social" style="color: #55acee" target="_blank">
