                                            ...
                                            <div class="col-lg-6 col-sm-6">
                                                <form class="checkout-form product-form">
                                                    ...
                                                    <div class="checkout-form-inner">
                                                        ...
                                                        <div class="i-boxb">
                                                            <input class="checkout-radio" type="radio" name="tag" id="credio"/>
                                                            <label class="cradio" for="credio">Checkout as Guest</label>
                                                        </div>
                                                        <div class="i-boxb">
                                                            <input class="checkout-radio" type="radio" name="tag" id="craiot"/>
                                                    ...
                                                    <div class="user-bottom fix">
                                                        <button class="btn custom-button" type="button">continue</button>
                                                    </div>
                                                </form>
                                            </div>
                                            <div class="col-lg-6 col-sm-6">
                                            ...
                                            <form action="#">
                                                <div class="form">
                                                            ...
                                                            <li>
                                                                <div class="field fix">
                                                                    ...
                                                                    <div class="input-box">
                                                                        ...
                                                                        <input type="email" class=" border-color" id="email"/>
                                                                    </div>
                                                                </div>
                                                            </li>
                                                            <li>
                                                    ...
                                                    <div class="button-check">
                                                        <div class="">
                                                            <span class="left-btn"><a href=""><i class="fa fa-long-arrow-up"></i>Back</a></span><button type="submit" class="btn right-btn custom-button">Continue</button>
                                                        </div>
                                                    </div>
                                                </div>
                                            </form>
                                                ...
                                                <table class="tablec">
                                                    ...
                                                    <tr>
                                                        <td colspan="4">
                                                            <div class="button-check">
                                                                <div class="">
                                                                    <span class="left-btn"><a href="">Forgot an Item? Edit Your Cart</a></span><button type="submit" class="btn right-btn custom-button">Continue</button>
                                                                </div>
                                                            </div>
                                                        </td>
                                                    </tr>
