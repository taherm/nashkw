...
return [
    ...
    'merchantId' => env('TAP_MERCHANT_ID', 153735), //Your ID provided by Tap
    ...
    'gatewayDefault' => "ALL",
    'paymentUrl' => env('TAP_PAYMENT_URL','http://www.gotapnow.com/TapWebConnect/Tap/WebPay/PaymentRequest'),
